...
public class Humanbeing extends TableImpl<HumanbeingRecord> {
     ...
     */
    public final TableField<HumanbeingRecord, WeaponType> WEAPONTYPE = createField(DSL.name("weapontype"), SQLDataType.VARCHAR.asEnumDataType(WeaponType.class), this, "");

    /**
     * The column <code>public.humanbeing.mood</code>.
     */
    public final TableField<HumanbeingRecord, Mood> MOOD = createField(DSL.name("mood"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(Mood.class), this, "");
